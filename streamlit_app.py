...
<style>
    ...
    /* 2. Custom KPI Card Styles (Restored original feel, just reduced size) */
    .kpi-card {
    ...
    /* 4. Prevent Streamlit from dimming unselected tabs (Keeps your theme colors) */
...
if df.empty:
    ...
    # Apply date filters only if changed from absolute min/max defaults
    ...
    with tab1:
        # Hide State & Source Portal columns from the final table
