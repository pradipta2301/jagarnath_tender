...
/* Updated Tag CSS so massive GeM categories look like neat boxes instead of stretched pills */
...
"""
# Replacing newlines prevents Streamlit from parsing this as a code block!
...
">
    ...
    <div style="position: absolute; bottom: 35px; right: 55px; text-align: center; text-shadow: 0px 4px 6px rgba(0,0,0,0.4);">
        ...
        <div style="font-size: 0.8rem; font-weight: 500; color: #e2e8f0; letter-spacing: 4px;">
            <span style="color: #f59e0b;">&mdash;</span> TRUST | QUALITY | COMMITMENT <span style="color: #f59e0b;">&mdash;</span>
        </div>
    </div>
</div>
"""
# Replacing newlines stops Streamlit from rendering the Header as a script block!
...
with tab1:
    if filtered_df.empty:
        ...
        for _, row in filtered_df.iterrows():
            ...
            # SMART CHECK: If the Title is EXACTLY the same as the Category (GeM bug), hide the redundant title!
            ...
            """
            # Replacing newlines stops Streamlit from rendering the cards as code blocks!
